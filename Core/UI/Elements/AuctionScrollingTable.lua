...
function AuctionScrollingTable.SetSelectedRecord(self, record)
	print("trace step AuctionScrollingTable.SetSelectedRecord")
...
function AuctionScrollingTable.GetSelectedRecord(self)
	-- add
	-- print("trace step AuctionScrollingTable.GetSelectedRecord")
	-- add
	
	local selection = self:GetSelection()
	
	-- add
	-- local buyout = isBuy and selection:GetField("buyout") or TSM.Auction.Util.GetRequiredBidByScanResultRow(selection)
	-- local stackSize = selection:GetField("stackSize")
	-- local itemString = selection:GetField("itemString")
	-- print("selection", selection)
	-- print("self._baseRecordByHash[selection]", self._baseRecordByHash[selection])
	-- add
...
function private.RowOnDoubleClick(frame)
	print("trace step RowOnDoubleClick")
